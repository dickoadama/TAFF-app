...
<div class="container mx-auto px-4 py-8 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden transform transition-all duration-500 hover:scale-105 animate__animated animate__fadeIn animate__delay-0.2s">
        <div class="bg-gradient-to-r from-blue-500 to-purple-600 p-6 text-center">
            <h1 class="text-3xl font-bold text-white animate__animated animate__fadeInDown">Connexion</h1>
            <p class="text-blue-100 mt-2 animate__animated animate__fadeInUp animate__delay-0.3s">Connectez-vous à votre compte pour continuer</p>
        </div>
        ...
        <div class="p-8">
            <form method="POST" action="{{ route('login.post') }}" class="space-y-6">
                ...
                <div class="flex items-center justify-between animate__animated animate__fadeInUp animate__delay-0.6s">
                    <div class="flex items-center">
                        <input type="checkbox" name="remember" id="remember" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        <label for="remember" class="ml-2 block text-sm text-gray-700">Se souvenir de moi</label>
                    </div>
                    
                    <a href="#" class="text-sm text-blue-600 hover:text-blue-800 transition-colors duration-300">Mot de passe oublié?</a>
                </div>
            ...
            <div class="mt-8 text-center animate__animated animate__fadeInUp animate__delay-0.8s">
                <p class="text-gray-600">
                    Vous n'avez pas de compte? 
                    <a href="{{ route('register') }}" class="text-blue-600 hover:text-blue-800 font-medium transition-colors duration-300 underline">S'inscrire</a>
                </p>
            </div>
        </div>
    </div>
