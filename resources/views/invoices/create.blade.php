            ...
            <form action="{{ route('invoices.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="invoice_number" id="invoice_number" class="form-input w-full" value="{{ old('invoice_number') }}" required>
                    ...
                    <div>
                        ...
                        <input type="date" name="issued_date" id="issued_date" class="form-input w-full" value="{{ old('issued_date') }}" required>
                        @error('issued_date')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="notes" id="notes" rows="4" class="form-input w-full">{{ old('notes') }}</textarea>
                        @error('notes')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
