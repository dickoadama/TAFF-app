...
<div class="container mx-auto px-4 py-8">
    <div class="text-center mb-12">
        <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Nos Artisans par Spécialité</h1>
        <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            Découvrez la diversité des artisans qualifiés disponibles sur TAFF dans différentes spécialités
        </p>
    </div>

    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <!-- Spécialité Bâtiment -->
        <div id="batiment" class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden transition-all duration-300 hover:shadow-xl">
            <div class="bg-gradient-to-r from-blue-500 to-purple-600 p-6">
                <h2 class="text-2xl font-bold text-white"><i class="fas fa-building mr-3"></i>Bâtiment</h2>
            </div>
            <div class="p-6">
                <ul class="space-y-3">
        ...
        <!-- Spécialité Services -->
        <div id="services" class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden transition-all duration-300 hover:shadow-xl">
        ...
        <div id="alimentation" class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden transition-all duration-300 hover:shadow-xl">
        ...
        <!-- Spécialité Fabrication -->
        <div id="fabrication" class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden transition-all duration-300 hover:shadow-xl">
