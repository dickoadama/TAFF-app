...
<div class="container mx-auto px-4 py-8 animate__animated animate__fadeIn">
            ...
            <div class="card-body">
                <div class="flex items-center">
                    ...
                    <div class="animate__animated animate__fadeIn">
                        <p class="text-gray-500 text-sm">Demandes de service</p>
                        <p class="text-3xl font-bold animate__animated animate__fadeIn">{{ $totalServiceRequests }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="card animate__animated animate__fadeInUp animate__delay-1.2s">
            <div class="card-header">
                <h2 class="text-2xl font-semibold animate__animated animate__fadeIn">Demandes de service récentes</h2>
            </div>
            <div class="card-body">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-200 animate__animated animate__fadeIn">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('service-requests.show', $request) }}" class="text-primary hover:text-secondary mr-3 animate__animated animate__fadeIn transform hover:scale-110">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('service-requests.edit', $request) }}" class="text-accent hover:text-amber-600 animate__animated animate__fadeIn transform hover:scale-110">
                ...
                @else
                    <p class="text-gray-500 text-center py-4 animate__animated animate__fadeIn">Aucune demande de service récente.</p>
                @endif
            </div>
        </div>
